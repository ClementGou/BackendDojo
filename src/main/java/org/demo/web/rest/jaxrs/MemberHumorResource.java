...
public class MemberHumorResource extends AbstractResourceController {
	...
	@Path("/humor/{day}")
	@Produces({ MediaType.APPLICATION_JSON })
	public double getTeamHumorByDay(@PathParam("day") String day) { //
		// TODO: rajouter date par défaut en cas
		// d'absence de date
		double teamHumorLevel = memberHumorService.calculateTeamHumor(day);
		logger.info("getTeamHumorByDay(" + day + "). Result: " + teamHumorLevel);
		return teamHumorLevel;
	}
}
